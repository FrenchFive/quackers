...
### FUNCTIONS :
- 👨🏻‍💻 // **Admin Functions** <sup>[Allows Admins to change value for the bot]</sup>
...
- 🪙 // **Coins** <sup>[Manage Coins earned on Discord]</sup>
...
- 🎲 // **Games** <sup>[Play Games and earn Coins]</sup>
...
- 😴 // **PASSIVE Actions** <sup>[Users are Rewarded for using the Discord Channel]</sup>
